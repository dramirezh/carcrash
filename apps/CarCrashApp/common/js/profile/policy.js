	...
	{		
   	...
   	validateAlphaNumeric("searchSubMark");
   	validateAlphaNumeric("txtSeries");
   	validatePolicyNumber("txtPolicyNo");
	...
	function ondeletedUpdatePolicy(){
		...
		{			
			navigator.camera.getPicture(
			        ...
			        { quality: 50, destinationType: navigator.camera.DestinationType.FILE_URI, sourceType : navigator.camera.PictureSourceType.CAMERA, saveToPhotoAlbum: true, targetWidth: 480,
			        	  targetHeight: 640,  });
		}
		var showDate=0;		
		...
		function validateAlphaNumeric(inputName){
		...
		function validatePolicyNumber(inputName){
			 $('#'+inputName).keypress(function(key) {        		
